...
public class Transaction {
	...
	private SimpleDateFormat dateSimpleFormat = new SimpleDateFormat(DATE_FORMAT);
	...
	private void addCurrentBalanceTo(StringBuilder builder, Amount currentBalance) {
		builder.append("| ")
			   .append(currentBalance.moneyFormat());
	}
	...
	private String valueToString() {
		String stringValue = " " + value.absoluteValue().moneyFormat();
		return stringValue;
	}

	private void addDateTo(StringBuilder builder) {
		builder.append(dateSimpleFormat.format(date));
		builder.append(" |");
	}
